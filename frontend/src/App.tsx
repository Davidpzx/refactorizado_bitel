...
// Eager: Auth y Layout (necesarios antes del primer render)
import { LoginPage } from './pages/auth/LoginPage'

// Lazy: todas las páginas protegidas se cargan solo cuando se navega a ellas
