...
const variantClasses: Record<Variant, string> = {
  ...
  gold:        'bg-[linear-gradient(180deg,#6366f1,#4f46e5)] text-white border border-[#4338ca] font-semibold shadow-[0_1px_2px_rgba(0,0,0,0.2)] hover:brightness-110 hover:-translate-y-px hover:shadow-[0_6px_18px_-4px_rgba(99,102,241,0.5)] focus:ring-indigo-500',
