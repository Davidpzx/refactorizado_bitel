...
const toneClasses: Record<ActionTone, string> = {
  ...
  edit: 'hover:border-amber-500 hover:bg-amber-500/10 hover:text-amber-600 dark:hover:border-amber-500 dark:hover:bg-amber-500/10 dark:hover:text-amber-300 focus:ring-amber-500',
...
export function ActionIconButton({
  ...
  return (
    <button
      ...
      title={label}
      className={[
        'h-8 w-8 inline-flex items-center justify-center rounded-md border transition-all duration-200 active:scale-95',
