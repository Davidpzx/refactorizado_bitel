...
const variantClasses: Record<Variant, string> = {
  default:     'border-indigo-200/70 bg-indigo-50 text-indigo-700 dark:border-indigo-400/15 dark:bg-indigo-500/10 dark:text-indigo-300',
  ...
  gold:        'border-indigo-200/70 bg-indigo-50 text-indigo-700 dark:border-indigo-400/15 dark:bg-indigo-500/10 dark:text-indigo-300',
